...
const UserEditInfo = (props) => {
  ...
  const editUserInfo = async(token, updateName, updateEmail, updatePassword) => {
    try{
        const result = await editUserInfoCall(token, updateName, updateEmail, updatePassword);
        if(result.success){
            handleClose();
          ...
          <Modal.Body>
            <form>
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                ...
                <Form.Control type="email" value={updateEmail} placeholder="Enter New Email" onChange={(event) => {
              ...
              <Form.Group className="mb-3" controlId="formBasicPassword">
                ...
                <Form.Control type="password" value={updatePassword} placeholder="Enter New Password" onChange={(event) => {
